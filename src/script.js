...
createApp({
    ...
    this.uniforms = {
      ...
      smoothing: { value: this.params.smoothing },
    	colorA: { value: new THREE.Color(this.params.colorA).multiplyScalar(this.params.multiplierA) },
    	colorB: { value: new THREE.Color(this.params.colorB).multiplyScalar(this.params.multiplierB) },
    ...
    const updateColorA = () => {
    	this.uniforms.colorA.value.set(this.params.colorA).multiplyScalar(this.params.multiplierA)
    }    
    const updateColorB = () => {
    	this.uniforms.colorB.value.set(this.params.colorB).multiplyScalar(this.params.multiplierB)
    }
    gui.addColor(this.params, 'colorA').onChange(updateColorA)
    gui.addColor(this.params, 'colorB').onChange(updateColorB)
    gui.add(this.params, 'multiplierA', -2, 2).onChange(updateColorA)
    gui.add(this.params, 'multiplierB', -2, 2).onChange(updateColorB)
